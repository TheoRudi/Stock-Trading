...
# readTickers("./Stock_Exchanges/NASDAQ_90_Tickers.txt")
...
RankedStocks = f_score_df.sum().sort_values(ascending=False)

text_file = open("Ranked_Stocks_Piotroski.txt", "w")
